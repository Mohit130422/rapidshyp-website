...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 content">
                    ...
                    <div class="body">
                        <h3 class="heading">Streamline Your <br> eCommerce Delivery</h3>
    ...
    <section class="hook-rehook embrace-the-growth">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                    <h3 class="heading mb-0">Move Forward Without RTOs</h3>
            ...
            <div class="row mt-5 align-items-center">
                <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                    <h3 class="heading mb-0">Why Choose RapidShyp As Your <br> eCommerce Delivery Partner?</h3>
                    <p class="descrp">Incredible Features of the Best eCommerce Delivery Services in India</p>
                </div>
            </div>
            <div class="row mt-5 align-items-center justify-content-center">
                <div class="col-10">
