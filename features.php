...
<body>
    ...
    <section class="hero-area-bg feature">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2 class="title">The all-in-one shipping platform you've been looking for </h2>
                    </div>
            ...
            <div class="feature-slider">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <ul>
                                <div class="owl-carousel owl-theme sticky-features" id="key-features">
                                    <li>
                                        <div class="card">
                                            <div class="head">
                                                <div class="icon">
                                                    <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/feature1.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="body">
                                    ...
                                    <li>
                                        <div class="card even">
                                            <div class="head">
                                                <div class="icon">
                                                    <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/f-package.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="body">
                                    ...
                                    <li>
                                        <div class="card">
                                            <div class="head">
                                                <div class="icon">
                                                    <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/distance.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="body">
                                    ...
                                    <li>
                                        <div class="card even">
                                            <div class="head">
                                                <div class="icon">
                                                    <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/universal_currency_alt.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="body">
                                                <strong>Zero Platform <br>Fees</strong>
                                                <p>Start with RapidShyp at no cost – no platform or setup fee is
                                                    required. <br>Simply top up your account and pay only for the orders
                                                    you ship</p>
                                            </div>
                                        </div>
                                    </li>
    ...
    <section class="what-makes-better2 better-feature ">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-12 text-center">
                    <h3 class="heading">Dynamic Functionalities To Supercharge Shipping</h3>
                    <p class="sub-heading">Boost efficiency, productivity, and competitive advantage with RapidShyp's
                        advanced features. Ensure smooth shipping management</p>
                </div>
                <div class="row mt-5 align-items-center col-reverse">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 p-3">
                        <div>
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/feature1.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 p-3">
                        <div>
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/feature2.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 text-start">
                        <div class="info">
                ...
                <div class="row align-items-center col-reverse">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 p-3">
                        <div>
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/feature3.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 p-3" >
                        <div>
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/feature4.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 text-start">
                        <div class="info">
                            <h5>RapidCOD</h5>
                            <p class="mb-5">Slash the wait from two weeks to two
                ...
                <div class="row align-items-center col-reverse">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 p-3">
                        <div>
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/feature5.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 p-3" >
                        <div>
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/feature6.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5 text-start">
                        <div class="info">
                            <h5>Reporting and Analytics</h5>
                            <p class="mb-5">Make informed and data-driven decisions.
    ...
    <section class="ready-to-explore customer-love">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h3 class="heading mb-0">Build Steller Xperience<br>Beyond Boxes</h3>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <p class="descrp">Foster a sense of confidence and trust among your buyers with a branded tracking
                        page and shipment notifications</p>
                    <!-- <a href="#">Learn More</a> -->
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="owl-carousel owl-theme" id="feature-carousel" >
                        <div class="item">
                            <div class="icon">
                                <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/clear-visible.svg" alt="">
                            </div>
                            <div class="card">
                                <div class="body">
                                    <strong>Clear Visibility and <br> Communication</strong>
                                    <p>Instant access to shipment location and status lets buyers strategize and reduce
                                        uncertainties, bolstering customer service with precise delivery forecasts and
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/campaign.svg" alt="">
                            </div>
                            <div class="card">
                                <div class="body">
                                    <strong>Branded Communication for <br> Brand Recall</strong>
                                    <p>Make your brand look world-class with a tracking page tailored to your brand’s
                                        Image. Look like a pro when you’re just starting out!
                                    </p>
                                    <!-- <a href="#">Know More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/icon/call-plus.svg" alt="">
                            </div>
                            <div class="card">
                                <div class="body">
    ...
    <section class="what-makes-better2 better-feature partners">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8 col-md-6 col-sm-12 text-start">
                    <div class="info">
                        <h5 class="bold-heading">Shipping Automation to Prioritize Core Business</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 mb-5 p-3">
                    <p class="sub-title mb-3">Partner with a platform with tools that lets you do more than just
                            shipping. Reduce manual efforts to save time and focus on sales</p>
                </div>
            </div>
            <div class="row px-4">
                <div class="col-lg-6 col-md-6 col-sm-2 mb-3">
                    <div class="info-card">
                        <div class="info">
                            <h4>Manifest Creation</h4>
                            <p>Get a bird’s eye view of your shipment. Improve tracking and transparency with pick-up and delivery information</p>
                        </div>
                        <div class="img">
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/manifest.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-2 mb-3">
                    <div class="info-card">
                        ...
                        <div class="img">
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/invoice.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
