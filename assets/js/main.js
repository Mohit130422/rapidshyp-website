...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const toggleFeatures = document.getElementById('features');
    const toggleFeaturesDiv = document.getElementById('features-menu');
    ...
    // Handle Features menu hover
    toggleFeatures.addEventListener('mouseenter', () => showMenu(toggleFeaturesDiv));
    toggleFeatures.addEventListener('mouseleave', () => setTimeout(() => {
        if (!toggleFeaturesDiv.matches(':hover')) hideMenu(toggleFeaturesDiv);
    }, 100));
    toggleFeaturesDiv.addEventListener('mouseenter', () => showMenu(toggleFeaturesDiv));
    toggleFeaturesDiv.addEventListener('mouseleave', () => hideMenu(toggleFeaturesDiv));
