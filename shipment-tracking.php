                    ...
                    <div class="content">
                        ...
                        <div class="status">
                            <div class="status-img">
                                <img src="assets/images/icon/o-received.svg" alt="">
                            </div>
                        ...
                        <div class="status">
                            <div class="status-img">
                                <img src="assets/images/icon/o-picked.svg" alt="">
                            </div>
                            <div class="circle"></div>
                            <div class="info">
                        ...
                        <div class="status">
                            <div class="status-img">
                                <img src="assets/images/icon/o-transit.svg" alt="">
                            </div>
                            <div class="circle"></div>
                            <div class="info">
                        ...
                        <div class="status">
                            <div class="status-img">
                                <img src="assets/images/icon/out-for-delivery.svg" alt="">
                            </div>
                            <div class="circle"></div>
                            <div class="info">
    ...
    <section class="ready-to-explore track-experience ">
        <div class="container">
            <div class="row align-items-center col-reverse">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="image">
                        <img src="assets/images/track-experience.png" alt="">
                    </div>
                </div>
            </div>
        </div>
