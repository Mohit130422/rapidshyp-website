                    ...
                    <div class="col-12 text-center">
                        ...
                        <div class="join-us mb-2">
                            <form action="#" id="submit-button">
                                ...
                                <button type="submit" class="solid-action-btn" id="openWaitlistForm"><span>Schedule Demo</span><img src="assets/images/icon/send.svg" alt=""></button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 col-sm-12 mb-4">
                            <form action="#" class="d-flex" id="explore-form">
                                <input type="text" name="" id="explore-email" placeholder="Type Your Email Here"
                                    required>
                                <button type="submit" class="solid-action-btn" id="openWaitlistForm"><span>Schedule Demo</span> <img src="assets/images/icon/forward_to_inbox.svg"
                                        alt=""></button>
                            </form>
                        </div>
                    </div>
