...
<body>
    ...
    <section class="terms-condition">
        <div class="container">
            ...
            <div class="mb-4">
                <h2>Personal Information/Sensitive Personal Data:</h2>
                <p class="mb-3"><b>“Personal Information”</b> means any information that relates to the User, which,
                    either directly or indirectly, is capable of identifying the person concerned.</p>
                <p class="mb-3"><b>“Sensitive Personal Data or Information”</b> means personal information of a User
                    relating to password; financial information such as bank account or credit card or debit card or
                    other payment instrument details; physical, physiological and mental health condition; sexual
                    orientation; medical records and history; biometric information; any detail relating to the above as
                    provided to or received by the Company for processing or storage. However, any data/information that
            ...
            <div class="mb-4">
                ...
                <ol class="mb-3" type="a">
                    ...
                    <li>Technical administration and customization of Platform;</li>
                    <li>Ensuring that the Platform content is presented to the Users in an effective manner;</li>
                    <li>Delivery of personalized information and targeted as well as non-targeted advertisements by the
                        Company to the User;</li>
                    ...
                    <li>For purposes of research, analysis, business intelligence, reporting and
                        improvement/development/advancement of the Company’s business, Platform and/or the Services;
                    </li>
                    <li>Dealing with requests, enquiries, complaints or disputes and other customer care related
                        activities including those arising out of the Users’ request of the Services and all other
                        general administrative and business purposes;</li>
                    <li>Communicate any changes in our Services or this Privacy Policy or the Terms of Use to the Users;
                    </li>
                    <li>Verification of identity of Users and to perform checks to prevent frauds;</li>
                    <li>Investigating, enforcing, resolving disputes and applying our Terms of Use and Privacy Policy,
                        either ourselves or through third party service providers;</li>
                    <li>To comply with applicable legal requirements and our various policies/terms; and</li>
                    <li>Any other purpose that may be necessary to provide the Services that You have opted for.</li>
                </ol>
            </div>
            <div class="mb-4">
                ...
                <p class="mb-3">The Company may also make all User Information accessible to its employees and data
                    ...
                    Privacy Policy. The Company takes adequate steps to ensure that all the employees and data
                    processors/third party vendors, who have access to, and are associated with the processing of User
                    Information, respect its confidentiality and that such data processors/third party vendors adopt at
                    least such reasonable level of security practices and procedures as required under applicable law.
                    However, the Company does not disclose information, individually labeled or aggregated, obtained
                    through Marketplace Application programming interface on behalf of a User to other Users or any
                    third parties, unless required by law.</p>
                <p class="mb-3">Non-personally identifiable information may be disclosed to third party ad servers, ad
                    agencies, technology vendors and research firms to serve non-targeted advertisements to the Users.
                    The Company may also share its aggregate findings (not specific information) in a non- personally
                    identifiable form based on information relating to the User’s internet use (to the extent set out in
                    this Privacy Policy) to prospective, investors, strategic partners, sponsors and others in order to
                    help growth of Company's business.</p>
                <p class="mb-3">We may also disclose or transfer the User Information, to another third party as part of
                    reorganization or a sale of the assets or business of Company. Any third party to which the Company
                    transfers or sells its assets will have the right to continue to use the Personal Information and/or
                    other information that a User provides to Us in a manner consistent with this Privacy Policy.</p>
                <p class="mb-3">The relevant information/data may be required to be shared by the Company with its
                    affiliates, subsidiaries and group companies in order to facilitate the provision of Services by the
                    Company and/or its affiliates, subsidiaries and group companies to us and/or to You. To the extent
                    that these entities have access to Your Personal Information which is shared by the Company, the
                    Company shall take adequate steps to ensure that these entities shall adopt at least such reasonable
                    level of security practices and procedures as required under applicable law to ensure security of
                    Personal Information.</p>
            </div>
            <div class="mb-4">
                <h2>Links to Third-Party:</h2>
                <p class="mb-3">The links to third-party advertisements, third party websites or any third-party
                    electronic communication services (referred to as <b>“Third Party Links”</b>) may be provided on the
            ...
            <div class="mb-4">
                ...
                <p class="mb-3">For the purpose of providing the Services and for other purposes identified in this
                    Privacy Policy, we are required to collect and host certain data and information of the Users. We
                    are committed to protecting Your Personal Information, and to that end, the Company adopts
                    reasonable security practices and procedures to implement technical, operational, managerial and
                    physical security control measures in order to protect the Personal Information in its possession
                    from loss, misuse and unauthorized access, disclosure, alteration and destruction. While we try our
                    best to provide security that is commensurate with the industry standards, due to the inherent
                    vulnerabilities of the internet, we cannot ensure or warrant complete security of all information
                    that is being transmitted to Us.</p>
                <p class="mb-3">The Company takes adequate steps to ensure that third parties to whom the Personal
                    Information may be transferred adopt at least such reasonable level of security practices and
                    procedures as required under applicable law to ensure security of Personal Information.</p>
            ...
            <div class="mb-4">
                ...
                <p class="mb-3">In case the User does not provide his/her information or consent for usage of Personal
                    ...
                    features and benefits for which the said information was sought.</p>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <p class="mb-3">You agree while using Platform, You shall not upload, modify, publish, transmit update
                    or share any information which:</p>
                <ol class="mb-3" type="a">
                    <li>belongs to another person and to which the user does not have any right;</li>
                    <li>is obscene, pornographic, paedophilic, invasive of another’s privacy including bodily privacy,
                        insulting or harassing on the basis of gender, racially or ethnically objectionable, relating or
                        encouraging money laundering or gambling, or promoting enmity between different groups on the
                        grounds of religion or caste with the intent to incite violence;</li>
                    ...
                    <li>threatens the unity, integrity, defence, security or sovereignty of India, friendly relations
                        ...
                        offence, or prevents investigation of any offence, or is insulting other nation;</li>
            ...
            <div class="mb-4">
                ...
                <p class="mb-3">We may update this Privacy Policy from time to time and shall notify you regarding the
                    Policy as well as any such changes periodically and at least once a year. However, you are advised
                    to review this page/policy periodically for any changes. Your continued usage of the Services shall
