        ...
        <div id="hero-area" class="hero-area">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="img-desk">
                            <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/dtdc-hero.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container position-relative">
            ...
            <div class="row mt-4 align-items-center justify-content-center">
                <div class="col-lg-5 col-md-6 col-sm-12 p-3">
                    <div>
                        <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/why-dtdc01.png"
                            alt="">
                    </div>
                </div>
            ...
            <div class="row mt-4 align-items-center col-reverse justify-content-center">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 p-3">
                    <div>
                        <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/why-dtdc02.png"
                            alt="">
                    </div>
                </div>
            </div>
            <div class="row mt-4 align-items-center justify-content-center">
                <div class="col-lg-5 col-md-6 col-sm-12 p-3">
                    <div>
                        <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/why-dtdc03.png"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12 text-start">
            ...
            <div class="row mt-4 align-items-center col-reverse justify-content-center">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 p-3">
                    <div>
                        <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/why-dtdc04.png"
                            alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row  align-items-center w-100">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="image text-center">
                        <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/dtdc-partner.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="is-rto-eating-profit delhivery-couriers" style="padding: 0 0 60px; height: auto;">
        <div class="container deliver-sucess dtdc-bg" style="padding: 3rem 0 0;">
            <div class="row align-items-center col-reverse w-100">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="image">
                        <img src="https://storage.googleapis.com/rapidshyp-website-cdn/temp/courier-integration/dtdc/dtdc-your-ecommerce.png" alt="">
                    </div>
                </div>
